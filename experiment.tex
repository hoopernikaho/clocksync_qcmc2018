...
% In this experiment, we seeded (\textbf{any better term than seeded?}) both timestamps with a common frequency reference from a rubidium oscillator so that the offset between the two clocks does not drift over the duration of the measurement.
% We will lift this constraint in our future work by applying the algorithm described in~\cite{Ho2009}.
